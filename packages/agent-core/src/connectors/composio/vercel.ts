...
export const vercelComposioSpecs: ComposioToolSpec[] = [
  // ── Read ──────────────────────────────────────────────────────
  {
    ...
    description: "Get details of a Vercel project. Read-only.",
    parameters: z
      .object({
  ...
  },
  {
    ...
    description: "List deployments for the user or team. Read-only.",
    parameters: z
      .object({
  ...
  },
  {
    ...
    description: "Get details of a specific deployment. Read-only.",
    parameters: z
      .object({
  ...
  },
  {
    ...
    description: "Get build/runtime events for a deployment. Read-only.",
    parameters: z
      .object({
        idOrUrl: z.string().describe("Deployment ID or URL"),
        teamId: z.string().optional().describe("Team ID"),
  ...
  },
  {
    ...
    description: "Get logs for a deployment. Read-only.",
    parameters: z
      .object({
        idOrUrl: z.string().describe("Deployment ID or URL"),
        teamId: z.string().optional().describe("Team ID"),
  ...
  },
  {
    ...
    description: "List checks run against a deployment. Read-only.",
    parameters: z
      .object({
  ...
  },
  {
    ...
    description: "List environment variables for a project. Read-only.",
    parameters: z.object({ projectId: z.string().describe("Project ID") }).passthrough(),
  },
  {
    slug: "VERCEL_LIST_TEAMS",
    description: "List teams accessible to the authenticated user. Read-only.",
    parameters: z.object({}).passthrough(),
  },
  {
    slug: "VERCEL_LIST_ALIASES",
    description: "List domain aliases for the user or team. Read-only.",
    parameters: z
      .object({
        teamId: z.string().optional().describe("Team ID"),
        projectId: z.string().optional().describe("Filter by project"),
  ...
  },
  {
    ...
    description: "List authentication tokens for the current user. Read-only.",
    parameters: z.object({}).passthrough(),
  },
  {
    slug: "VERCEL_CHECK_DOMAIN_AVAILABILITY",
    description: "Check whether a domain is available for registration. Read-only.",
    parameters: z.object({ name: z.string().describe("Domain name") }).passthrough(),
  },
  {
    slug: "VERCEL_LIST_EDGE_CONFIGS",
    description: "List Edge Config stores. Read-only.",
    parameters: z.object({ teamId: z.string().optional().describe("Team ID") }).passthrough(),
  },
  {
    slug: "VERCEL_LIST_EDGE_CONFIG_ITEMS",
    description: "List items in an Edge Config store. Read-only.",
    parameters: z.object({ edgeConfigId: z.string().describe("Edge Config ID") }).passthrough(),
  },
  ...
  // ── Write ────────────────────────────────────────────────────
  {
    ...
    parameters: z
      .object({
        ...
        target: z.string().optional().describe("'production' or 'preview'"),
      })
      .passthrough(),
    preview: (a) => ({
      title: "Create deployment",
      preview: `Deploy ${String(a["project"] ?? a["name"] ?? "")}`,
      confirmText: "Deploy",
    }),
  },
  {
    ...
    parameters: z
      .object({
        ...
        type: z.string().describe("'plain', 'secret', or 'encrypted'"),
        target: z
          .array(z.string())
          .describe("Environments: 'production', 'preview', 'development'"),
      })
      .passthrough(),
    preview: (a) => ({
      title: "Add env variable",
      preview: `Add ${String(a["key"] ?? "")}`,
      confirmText: "Add",
    }),
  },
  {
    ...
    preview: (a) => ({
      ...
      preview: `Update project ${String(a["idOrName"] ?? "")}`,
      confirmText: "Update",
    }),
  },
  {
    ...
    preview: (a) => ({
      title: "Create token",
      preview: `Create token "${String(a["name"] ?? "")}"`,
  ...
  },
  {
    ...
    description:
      "Create a new Edge Config store for a project. Requires user approval before it runs.",
    parameters: z
      .object({
        name: z.string().describe("Edge Config name"),
        slug: z.string().describe("Edge Config slug"),
        projectId: z.string().describe("Project ID"),
      })
      .passthrough(),
    preview: (a) => ({
      title: "Create edge config",
      preview: `Create edge config "${String(a["name"] ?? "")}"`,
      confirmText: "Create",
    }),
  },
  ...
  // ── Irreversible ──────────────────────────────────────────────
  {
    ...
    preview: (a) => ({
      ...
      preview: `Delete deployment ${String(a["id"] ?? "")} — this cannot be undone`,
      confirmText: "Delete",
    }),
  },
  {
    ...
    preview: (a) => ({
      ...
      preview: `Delete project ${String(a["id"] ?? "")} — this cannot be undone`,
      confirmText: "Delete",
    }),
  },
  {
    ...
    preview: (a) => ({
      ...
      preview: `Delete env var ${String(a["id"] ?? "")} — this cannot be undone`,
      confirmText: "Delete",
    }),
  },
  {
    ...
    preview: (a) => ({
      title: "Delete token",
      preview: `Revoke token ${String(a["tokenId"] ?? "")} — this cannot be undone`,
      confirmText: "Revoke",
    }),
  },
]
...
export function makeComposioVercelDef(executor: ComposioExecutor): ConnectorDef {
  return {
    ...
    icon: "vercel",
    description:
      "Vercel — frontend deployment platform: projects, deployments, domains, edge config, and environment variables (via Composio).",
    ...
    setup: {
      ...
      collect: [
        ...
        {
          env: "COMPOSIO_VERCEL_AUTH_CONFIG_ID",
          label: "Composio Vercel auth config id",
          secret: false,
        },
      ],
