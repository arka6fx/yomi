...
export const microsoftTeamsComposioSpecs: ComposioToolSpec[] = [
  // ── Read ──────────────────────────────────────────────────────
  {
    ...
    description: "List Microsoft Teams accessible by the authenticated user. Read-only.",
    parameters: z
      .object({ top: z.number().int().optional().describe("Max results") })
      .passthrough(),
  },
  {
    slug: "MICROSOFT_TEAMS_GET_TEAM",
    description: "Get details of a specific team. Read-only.",
    parameters: z.object({ team_id: z.string().describe("Team ID") }).passthrough(),
  },
  {
    slug: "MICROSOFT_TEAMS_LIST_TEAM_MEMBERS",
    description: "List members of a team. Read-only.",
    parameters: z
      .object({
  ...
  },
  {
    ...
    description: "List channels in a team. Read-only.",
    parameters: z.object({ team_id: z.string().describe("Team ID") }).passthrough(),
  },
  {
    slug: "MICROSOFT_TEAMS_GET_CHANNEL",
    description: "Get details of a specific channel. Read-only.",
    parameters: z
      .object({
        team_id: z.string().describe("Team ID"),
  ...
  },
  {
    ...
    description: "Get a specific channel message. Read-only.",
    parameters: z
      .object({
        team_id: z.string().describe("Team ID"),
        channel_id: z.string().describe("Channel ID"),
  ...
  },
  {
    ...
    description: "List replies to a channel message. Read-only.",
    parameters: z
      .object({
        team_id: z.string().describe("Team ID"),
        channel_id: z.string().describe("Channel ID"),
  ...
  },
  {
    ...
    description: "List chats a user is part of. Read-only.",
    parameters: z
  ...
  },
  {
    ...
    description: "List messages (newest first) from a chat. Read-only.",
    parameters: z
      .object({
  ...
  },
  {
    ...
    description: "Get all messages from a chat. Read-only.",
    parameters: z.object({ chat_id: z.string().describe("Chat ID") }).passthrough(),
  },
  {
    slug: "MICROSOFT_TEAMS_GET_CHAT_MESSAGE",
    description: "Get a specific chat message. Read-only.",
    parameters: z
      .object({
        chat_id: z.string().describe("Chat ID"),
        message_id: z.string().describe("Message ID"),
  ...
  },
  {
    ...
    description: "List users in the organization directory. Read-only.",
    parameters: z
      .object({
        ["$top"]: z.number().int().optional().describe("Max results"),
  ...
  {
    slug: "MICROSOFT_TEAMS_LIST_TEAMS_TEMPLATES",
    description: "List available team templates. Read-only.",
    parameters: z.object({}).passthrough(),
  },
  {
    slug: "MICROSOFT_TEAMS_TEAMS_LIST_PEOPLE",
    description: "List people relevant to a user (from Microsoft Graph). Read-only.",
    parameters: z.object({ search: z.string().optional().describe("Search term") }).passthrough(),
  },
  ...
  // ── Write ────────────────────────────────────────────────────
  {
    ...
    parameters: z
      .object({
        displayName: z.string().describe("Team name"),
        visibility: z.string().describe("'private' or 'public'"),
        description: z.string().optional().describe("Team description"),
      })
      .passthrough(),
    preview: (a) => ({
      title: "Create team",
      preview: `Create team "${String(a["displayName"] ?? "")}"`,
  ...
  },
  {
    ...
    preview: (a) => ({
      ...
      preview: `Add ${String(a["user_id"] ?? "")} to team ${String(a["team_id"] ?? "")}`,
      confirmText: "Add",
    }),
  },
  {
    ...
    preview: (a) => ({
      ...
      preview: `Create channel "${String(a["name"] ?? "")}"`,
  ...
  },
  {
    ...
    description:
      "Create a new chat (or return an existing one-on-one chat). Requires user approval before it runs.",
    parameters: z
      .object({
        members: z.array(z.record(z.string(), z.unknown())).describe("Chat members"),
        chatType: z.string().describe("'oneOnOne' or 'group'"),
      })
      .passthrough(),
    preview: () => ({
      title: "Create chat",
      preview: "Create a new chat",
  ...
  },
  {
    ...
    description:
      "Schedule a new standalone Teams online meeting. Requires user approval before it runs.",
    parameters: z
      .object({
        subject: z.string().describe("Meeting subject"),
        start_date_time: z.string().describe("Start time (ISO 8601)"),
        end_date_time: z.string().describe("End time (ISO 8601)"),
      })
      .passthrough(),
    preview: (a) => ({
      title: "Create meeting",
      preview: `Schedule "${String(a["subject"] ?? "")}"`,
      confirmText: "Schedule meeting",
    }),
  },
  {
  ...
  },
  {
    ...
    preview: (a) => ({
      ...
      preview: `Update message ${String(a["message_id"] ?? "")}`,
      confirmText: "Update",
    }),
  },
  {
  ...
  },
  {
    ...
    preview: (a) => ({
      title: "Update team",
      preview: `Update team ${String(a["team_id"] ?? "")}`,
      confirmText: "Update",
    }),
  },
  {
    ...
    preview: (a) => ({
      title: "Archive team",
      preview: `Archive team ${String(a["team_id"] ?? "")}`,
      confirmText: "Archive",
    }),
  },
  {
    ...
    preview: (a) => ({
      ...
      preview: `Unarchive team ${String(a["team_id"] ?? "")}`,
  ...
  // ── Irreversible ──────────────────────────────────────────────
  {
    ...
    preview: (a) => ({
      title: "Delete team",
      preview: `Delete team ${String(a["team_id"] ?? "")} — this cannot be undone`,
      confirmText: "Delete",
    }),
  },
]
...
export function makeComposioMicrosoftTeamsDef(executor: ComposioExecutor): ConnectorDef {
  return {
    ...
    description:
      "Microsoft Teams — team chat and collaboration; manage teams, channels, chats, meetings, and messages (via Composio).",
    ...
    setup: {
      ...
      collect: [
        ...
        {
          env: "COMPOSIO_MICROSOFT_TEAMS_AUTH_CONFIG_ID",
          label: "Composio Microsoft Teams auth config id",
          secret: false,
        },
      ],
