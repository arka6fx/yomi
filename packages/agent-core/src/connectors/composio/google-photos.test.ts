...
describe("googlePhotosComposioSpecs", () => {
  ...
  it.each(["GOOGLEPHOTOS_LIST_ALBUMS", "GOOGLEPHOTOS_LIST_MEDIA_ITEMS", "GOOGLEPHOTOS_SEARCH_MEDIA_ITEMS", "GOOGLEPHOTOS_GET_ALBUM", "GOOGLEPHOTOS_BATCH_GET_MEDIA_ITEMS"])(
    "documents the app-created-only scope limitation for %s",
    (slug) => {
