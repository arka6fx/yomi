...
export const facebookComposioSpecs: ComposioToolSpec[] = [
  // ── Read ──────────────────────────────────────────────────────
  {
    ...
    description: "List pages the user manages. Read-only.",
    parameters: z
      .object({
  ...
  },
  {
    ...
    description: "Get details of a specific page. Read-only.",
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
      })
      .passthrough(),
  ...
  },
  {
    ...
    description: "List posts from a page. Read-only.",
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
  ...
  },
  {
    ...
    description: "Get details of a specific post. Read-only.",
    parameters: z.object({ post_id: z.string().describe("Post ID") }).passthrough(),
  },
  {
    slug: "FACEBOOK_GET_POST_INSIGHTS",
    description: "Get analytics/insights for a post. Read-only.",
    parameters: z
      .object({
        post_id: z.string().describe("Post ID"),
        metrics: z.string().optional().describe("Metrics to fetch"),
      })
      .passthrough(),
  },
  {
    slug: "FACEBOOK_GET_POST_REACTIONS",
    description: "Get reactions on a post. Read-only.",
    parameters: z.object({ post_id: z.string().describe("Post ID") }).passthrough(),
  },
  {
    slug: "FACEBOOK_GET_COMMENTS",
    description: "Get comments on a post or comment. Read-only.",
    parameters: z
      .object({
  ...
  },
  {
    ...
    description: "Get details of a specific comment. Read-only.",
    parameters: z.object({ comment_id: z.string().describe("Comment ID") }).passthrough(),
  },
  {
    slug: "FACEBOOK_GET_PAGE_INSIGHTS",
    description: "Get analytics/insights for a page. Read-only.",
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
        metrics: z.string().optional().describe("Metrics to fetch"),
  ...
  {
    slug: "FACEBOOK_GET_PAGE_PHOTOS",
    description: "List photos from a page. Read-only.",
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
        limit: z.number().int().optional().describe("Max results"),
  ...
  {
    slug: "FACEBOOK_GET_PAGE_VIDEOS",
    description: "List videos from a page. Read-only.",
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
        limit: z.number().int().optional().describe("Max results"),
  ...
  },
  {
    ...
    description: "List people and their roles on a page. Read-only.",
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
      })
  ...
  },
  {
    ...
    description: "List scheduled/unpublished posts for a page. Read-only.",
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
      })
  ...
  {
    slug: "FACEBOOK_GET_PAGE_CONVERSATIONS",
    description: "List Messenger conversations for a page. Read-only.",
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
        limit: z.number().int().optional().describe("Max results"),
  ...
  {
    slug: "FACEBOOK_GET_CONVERSATION_MESSAGES",
    description: "Get messages in a conversation. Read-only.",
    parameters: z.object({ conversation_id: z.string().describe("Conversation ID") }).passthrough(),
  },
  {
    slug: "FACEBOOK_GET_MESSAGE_DETAILS",
    description: "Get details of a specific message. Read-only.",
  ...
  // ── Write ────────────────────────────────────────────────────
  {
    ...
    parameters: z
      .object({
        ...
        link: z.string().optional().describe("Link to attach"),
      })
      .passthrough(),
    resolvedParams: PAGE_ID_RESOLVED,
    preview: (a) => ({
  ...
  },
  {
    ...
    parameters: z
      .object({
        post_id: z.string().describe("Post ID"),
        message: z.string().optional().describe("New post text"),
      })
      .passthrough(),
    preview: (a) => ({
      title: "Update post",
      preview: `Update post ${String(a["post_id"] ?? "")}`,
      confirmText: "Update",
    }),
  },
  {
    ...
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
        url: z.string().optional().describe("Photo URL"),
    ...
    preview: (a) => ({
      ...
      preview: String(a["message"] ?? "New photo post").slice(0, 100),
      confirmText: "Post",
    }),
  },
  {
    ...
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
        file_url: z.string().optional().describe("Video URL"),
        description: z.string().optional().describe("Caption"),
      })
      .passthrough(),
    resolvedParams: PAGE_ID_RESOLVED,
    preview: (a) => ({
      title: "Create video post",
      preview: String(a["description"] ?? "New video post").slice(0, 100),
      confirmText: "Post",
    }),
  },
  {
    ...
    description:
      "Create a comment on a post, or reply to a comment. Requires user approval before it runs.",
    parameters: z
      .object({
        object_id: z.string().describe("Post or comment ID"),
  ...
  },
  {
    ...
    preview: (a) => ({
      title: "Like",
      preview: `Like ${String(a["object_id"] ?? "")}`,
      confirmText: "Like",
    }),
  },
  {
    ...
    description:
      "Add a reaction (like, love, wow, etc.) to a post or comment. Requires user approval before it runs.",
    parameters: z
      .object({
        object_id: z.string().describe("Post or comment ID"),
    ...
    preview: (a) => ({
      title: "Add reaction",
      preview: `React to ${String(a["object_id"] ?? "")}`,
      confirmText: "React",
    }),
  },
  {
    ...
    description:
      "Send a text message from the page to a user via Messenger. Requires user approval before it runs.",
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
        recipient_id: z.string().describe("Recipient user ID"),
        message_text: z.string().describe("Message text"),
      })
      .passthrough(),
    resolvedParams: PAGE_ID_RESOLVED,
    preview: (a) => ({
      title: "Send message",
      preview: String(a["message_text"] ?? "").slice(0, 100),
      confirmText: "Send",
    }),
  },
  {
    ...
    description:
      "Publish a scheduled/unpublished post immediately. Requires user approval before it runs.",
    parameters: z.object({ post_id: z.string().describe("Post ID") }).passthrough(),
    preview: (a) => ({
      title: "Publish post",
      preview: `Publish post ${String(a["post_id"] ?? "")}`,
      confirmText: "Publish",
    }),
  },
  {
    ...
    description:
      "Change the scheduled publish time of an unpublished post. Requires user approval before it runs.",
    parameters: z
      .object({
        post_id: z.string().describe("Post ID"),
        scheduled_publish_time: z.number().int().describe("New scheduled time (Unix timestamp)"),
      })
      .passthrough(),
    preview: (a) => ({
      title: "Reschedule post",
      preview: `Reschedule post ${String(a["post_id"] ?? "")}`,
  ...
  },
  {
    ...
    description:
      "Update a page's settings (about, phone, website, etc.). Requires user approval before it runs.",
    parameters: z
      .object({
        page_id: z.string().optional().describe("Page ID (auto-filled if you manage one page)"),
      })
    ...
    preview: (a) => ({
      ...
      preview: `Update page ${String(a["page_id"] ?? "")}`,
      confirmText: "Update",
    }),
  },
  {
    ...
    parameters: z
      .object({
        ...
        tasks: z.array(z.string()).describe("Tasks to assign"),
      })
      .passthrough(),
    resolvedParams: PAGE_ID_RESOLVED,
    preview: (a) => ({
      title: "Assign page task",
      preview: `Assign tasks to ${String(a["user"] ?? "")}`,
      confirmText: "Assign",
    }),
  },
  ...
  // ── Irreversible ──────────────────────────────────────────────
  {
    ...
    preview: (a) => ({
      title: "Delete post",
      preview: `Delete post ${String(a["post_id"] ?? "")} — this cannot be undone`,
      confirmText: "Delete",
    }),
  },
  {
    ...
    preview: (a) => ({
      ...
      preview: `Delete comment ${String(a["comment_id"] ?? "")} — this cannot be undone`,
      confirmText: "Delete",
    }),
  },
  {
    ...
    preview: (a) => ({
      title: "Unlike",
      preview: `Unlike ${String(a["object_id"] ?? "")}`,
      confirmText: "Unlike",
    }),
  },
  {
    ...
    resolvedParams: PAGE_ID_RESOLVED,
    preview: (a) => ({
      title: "Remove page access",
      preview: `Remove ${String(a["user"] ?? "")} from page ${String(a["page_id"] ?? "")}`,
      confirmText: "Remove",
    }),
  },
]
...
export function makeComposioFacebookDef(executor: ComposioExecutor): ConnectorDef {
  return {
    ...
    icon: "facebook",
    description:
      "Facebook — manage pages, posts, comments, insights, and Messenger conversations (via Composio).",
    ...
    setup: {
      ...
      collect: [
        ...
        {
          env: "COMPOSIO_FACEBOOK_AUTH_CONFIG_ID",
          label: "Composio Facebook auth config id",
          secret: false,
        },
      ],
