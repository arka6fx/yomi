...
function DiscordIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 128 128" fill="none" role="img" aria-label="Discord">
      <path
        d="M108.357 23.252c-8.158-3.743-16.906-6.5-26.053-8.08-.167-.03-.333.046-.419.198-1.125 2.001-2.371 4.612-3.244 6.664-9.838-1.473-19.626-1.473-29.263 0-.873-2.098-2.164-4.663-3.295-6.664-.085-.147-.252-.223-.418-.198-9.142 1.575-17.891 4.333-26.054 8.08-.07.03-.131.082-.172.148C2.845 48.191-1.701 72.373.53 96.255c.01.117.075.229.166.3 10.948 8.04 21.554 12.921 31.962 16.156.167.051.343-.01.45-.147 2.462-3.362 4.656-6.908 6.538-10.636.111-.218.005-.477-.222-.564-3.481-1.32-6.796-2.93-9.985-4.759-.252-.147-.272-.508-.04-.68.67-.503 1.342-1.027 1.983-1.555.116-.096.277-.117.413-.056 20.948 9.565 43.627 9.565 64.328 0 .136-.066.298-.046.419.05.64.529 1.312 1.057 1.988 1.56.232.173.217.534-.035.68-3.189 1.864-6.504 3.44-9.99 4.755-.227.087-.328.351-.217.57 1.922 3.722 4.117 7.267 6.534 10.63.101.142.282.204.449.153 10.459-3.235 21.064-8.116 32.012-16.156.096-.071.157-.178.167-.295 2.67-27.61-4.47-51.593-18.925-72.856-.036-.07-.096-.122-.167-.152ZM42.773 81.713c-6.306 0-11.503-5.79-11.503-12.901 0-7.11 5.096-12.9 11.503-12.9 6.458 0 11.605 5.84 11.503 12.9 0 7.111-5.095 12.901-11.503 12.901Zm42.532 0c-6.306 0-11.503-5.79-11.503-12.901 0-7.11 5.096-12.9 11.503-12.9 6.458 0 11.604 5.84 11.503 12.9 0 7.111-5.045 12.901-11.503 12.901Z"
        fill="#5865F2"
      />
    </svg>
  )
...
function FirecrawlIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 128 128" fill="none" role="img" aria-label="Firecrawl">
      <path
        d="M78.275 0.81c0.4-1.135 0.187-0.994 0.98-0.093 4.999 5.673-4.207 13.014-8.666 26.355-2.433 7.275 0.043 13.095 4.282 17.75 0.301 0.88 1.655 1.184 1.822 0.209 0.689-4.056-0.712-8.348 4.851-12.495 0.54-0.403 1.466-0.428 1.548 0.244 1.473 12.176 14.478 15.877 18.324 26.56 1.851 5.136 2.292 9.753 2.197 11.59-0.201 3.853-2.288 10.524-1.911 10.604 3.949 0.806 4.827-4.336 5.26-3.271 2.254 5.558 3.188 10.858 3.128 15.81-0.072 6.245-1.715 11.942-4.26 16.918-0.184 0.359-0.373 0.714-0.564 1.065-0.281 0.512-0.57 1.015-0.869 1.508-3.722 6.178-8.79 11.067-13.687 14.279-0.724 0.473-1.513-0.189-1.376-1.04 0.043-0.268 0.059-0.528 0.055-0.779 2.412-9.792-3.054-16.95-6.141-25.934-0.184-0.54-0.833-0.769-1.317-0.47-1.948 1.212-3.738 2.821-5.202 4.657-0.58 0.72-1.732 0.231-1.597-0.688 1.575-10.568-0.325-22.35-9.905-31.107-0.629-0.583-1.63-0.025-1.49 0.823 2.172 13.364-11.431 23.208-18.215 33.397-3.736 5.558-4.859 12.756-3.288 19.246-0.096 0.285-0.107 0.574-0.02 0.865 0.241 0.816-0.669 1.481-1.378 1.015-5.9-3.871-11.931-10.216-16.313-18.046-0.283-0.507-0.562-1.023-0.831-1.541-0.238-0.462-0.475-0.929-0.701-1.402-6.083-12.597-7.74-28.432 1.535-43.895 0.93-1.553 1.699-3.601 2.854-5.123 0.455-0.859 0.828-1.088 1.181-0.417 1.234 2.356 2.757 11.065 8.398 13.397 0.724 0.298 1.271-0.292 1.329-1.076 0.184-2.625 0.333-5.232-0.381-7.414-16.168-49.264 35.957-49.016 40.367-61.501Z"
        fill="#FA5D19"
      />
    </svg>
  )
...
function LinkedInIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="none" role="img" aria-label="LinkedIn">
      <rect width="256" height="256" rx="48" fill="#0A66C2" />
      <path
        fill="#fff"
        d="M96 94.6c0 8.2-6.2 14.9-13.8 14.9-7.6 0-13.8-6.7-13.8-14.9 0-8.2 6.2-14.9 13.8-14.9 7.6 0 13.8 6.7 13.8 14.9ZM70 115.5h22.5v73.8H70v-73.8Zm38.5 0H131v10.7h.3c2.8-5.2 9.7-10.7 21.5-10.7 23 0 27.2 16.7 27.2 38.5v35.3h-22.5v-31.3c0-9.1-1.6-20-14-20s-15.7 10.8-15.7 21.3v30H108.5v-73.8Z"
      />
    </svg>
  )
}
...
function WhatsAppIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="none" role="img" aria-label="WhatsApp">
      <defs>
        <radialGradient id="wa-grad" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#20B038" />
          <stop offset="100%" stopColor="#20B038" stopOpacity="0" />
        </radialGradient>
      </defs>
      <rect width="256" height="256" rx="50" fill="#25D366" />
      <path
        d="M128 32C74.98 32 32 74.98 32 128c0 20.36 5.94 39.36 16.12 55.4L37.72 218.3a4 4 0 0 0 4.98 4.98l34.9-10.4A95.7 95.7 0 0 0 128 224c53.02 0 96-42.98 96-96S181.02 32 128 32Zm49.85 135.44c-2.28 6.42-11.3 11.76-18.5 13.33-4.92 1.08-11.36 1.94-33.06-7.14-27.7-11.6-45.56-39.6-46.96-41.42-1.4-1.82-11.18-14.88-11.18-28.38s7.1-20.12 9.62-22.86c1.12-1.22 2.44-1.52 3.26-1.52.82 0 1.64.02 2.36.04 1.6.04 3.6-.04 5.08.04 1.42.08 2.54.16 3.48 2.18 1.04 2.22 4.16 9.18 4.52 9.84.36.66.6 1.44.18 2.32-.42.88-1.64 1.88-2.22 2.42-.58.54-1.22 1.2-1.76 1.92-.58.76-1.16 1.56-.52 2.96.64 1.4 2.86 4.72 6.14 7.64 4.22 3.76 7.76 4.92 8.86 5.46 1.1.54 1.74.76 2.38-.56.64-1.32 2.72-4.84 3.44-6.24.72-1.4 1.44-1.56 2.46-.94 1.02.62 6.44 3.18 7.56 3.76 1.12.58 1.86.86 2.14 1.34.28.48.32 2.48-.24 4.54-.56 2.06-4.82 6.62-6.82 8.54-.56.54-1.12 1.08-1.12 1.64.04.6.28.96.58 1.32 0 0 5.32 7.34 11.16 9.86 1.6.7 2.88.96 3.96 1.32 1.08.36 3.48.34 4.86-.58 1.38-.92 3.24-3.06 4.44-5.06 1.2-2 2.52-2.06 4.26-1.52 1.74.54 11.04 5.2 12.94 6.14 1.9.94 3.16 1.4 3.62 2.18.46.78.42 3.14-1.86 9.56Z"
        fill="#fff"
      />
    </svg>
  )
...
function JiraIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" role="img" aria-label="Jira">
      <rect width="48" height="48" rx="10" fill="#2684FF" />
      <path
        d="M24 17.5c-1.5 1.5-1.5 4 0 5.5l5 5h0l-5 5c-1.5 1.5-1.5 4 0 5.5s4 1.5 5.5 0l7.8-7.8c1.5-1.5 1.5-4 0-5.5l-7.8-7.8c-1.5-1.5-4-1.5-5.5 0z"
        fill="#fff"
      />
      <path
        d="M15.5 9c-1.5 1.5-1.5 4 0 5.5l5 5h0l-5 5c-1.5 1.5-1.5 4 0 5.5s4 1.5 5.5 0l7.8-7.8c1.5-1.5 1.5-4 0-5.5l-7.8-7.8c-1.5-1.5-4-1.5-5.5 0z"
        fill="#DEEBFF"
      />
    </svg>
  )
...
function RedditIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" role="img" aria-label="Reddit">
      <rect width="48" height="48" rx="10" fill="#FF4500" />
      <circle cx="24" cy="26" r="14" fill="#fff" />
      <path
        d="M24 16c-1.4 0-2.6.9-3.1 2.2-2.3.3-4.1 1.8-4.8 3.8-.6-.3-1.3-.5-2-.5-2.2 0-4 1.8-4 4 0 1.6.9 3 2.3 3.6-.1.5-.2 1-.2 1.4 0 3.3 5.4 6 11.8 6s11.8-2.7 11.8-6c0-.5-.1-1-.2-1.5 1.3-.6 2.2-2 2.2-3.5 0-2.2-1.8-4-4-4-.7 0-1.4.2-2 .5-.7-2-2.5-3.5-4.8-3.8C26.6 16.9 25.4 16 24 16zm-7 6.5c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm14 0c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm-7 3.5c2 0 3.5.4 3.5 1 0 .6-1.6 1-3.5 1s-3.5-.4-3.5-1c0-.6 1.6-1 3.5-1zm-2.7 3.1c.4 0 .8.3.8.8 0 .9.9 1.6 1.9 1.6s1.9-.7 1.9-1.6c0-.4.4-.8.8-.8.5 0 .8.4.8.8 0 1.7-1.5 3.1-3.5 3.1s-3.5-1.4-3.5-3.1c0-.4.3-.8.8-.8zM18 27c.7 0 1.3.6 1.3 1.3 0 .7-.6 1.3-1.3 1.3s-1.3-.6-1.3-1.3c0-.7.6-1.3 1.3-1.3zm12 0c.7 0 1.3.6 1.3 1.3 0 .7-.6 1.3-1.3 1.3s-1.3-.6-1.3-1.3c0-.7.6-1.3 1.3-1.3z"
        fill="#FF4500"
      />
    </svg>
  )
...
function TodoistIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" role="img" aria-label="Todoist">
      <rect width="32" height="32" rx="6" fill="#E44332" />
      <path
        fill="#fff"
        d="M7 12.2l5.5 5.5 5.5-5.5 2.1 2.1-7.6 7.6L4.9 14.3l2.1-2.1zm0-3.2l5.5 5.5L25 7l2.1 2.1-14.6 14.6L4.9 11.1 7 9z"
      />
    </svg>
  )
}
...
function FigmaIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" role="img" aria-label="Figma">
      <rect width="32" height="32" rx="6" fill="#1E1E1E" />
      <path
        d="M11.998 25.998A3.998 3.998 0 0 1 8 22a3.998 3.998 0 0 1 3.998-3.998H16v3.998A3.998 3.998 0 0 1 11.998 25.998Z"
        fill="#F24E1E"
      />
      <path
        d="M8 14a3.998 3.998 0 0 1 3.998-3.998H16V18H11.998A3.998 3.998 0 0 1 8 14Z"
        fill="#F24E1E"
        opacity="0.5"
      />
      <path
        d="M16 10.002h3.998a3.998 3.998 0 0 1 0 7.996H16v-7.996Z"
        fill="#0ACF83"
      />
      <path
        d="M24 10.002a3.998 3.998 0 0 1 0 7.996 3.998 3.998 0 0 1 0-7.996Z"
        fill="#A259FF"
      />
      <path
        d="M8 6.002A3.998 3.998 0 0 1 11.998 2H16v7.996h-4.002A3.998 3.998 0 0 1 8 6.002Z"
        fill="#FF7262"
      />
    </svg>
  )
...
function ZoomIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="none" role="img" aria-label="Zoom">
      <rect width="256" height="256" rx="48" fill="#0B5CFF" />
      <path
        fill="#fff"
        d="M186.3 96.8v47.4c0 10.1-8.2 18.3-18.3 18.3h-76.3l-17.5 17.5v-17.5h-4.5c-10.1 0-18.3-8.2-18.3-18.3V96.8c0-10.1 8.2-18.3 18.3-18.3h98c10.1 0 18.3 8.2 18.3 18.3zm-18.3 0h-98v47.4h98V96.8z"
      />
    </svg>
  )
}
...
function YouTubeIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 180" fill="none" role="img" aria-label="YouTube">
      <rect width="256" height="180" rx="24" fill="#FF0000" />
      <path
        fill="#fff"
        d="M224.6 30.2c-2.6-10-10.4-17.8-20.4-20.4C186.1 5 128 5 128 5s-58.1 0-76.2 4.8c-10 2.6-17.8 10.4-20.4 20.4C26.6 48.3 26.6 90 26.6 90s0 41.7 4.8 59.8c2.6 10 10.4 17.8 20.4 20.4 18.1 4.8 76.2 4.8 76.2 4.8s58.1 0 76.2-4.8c10-2.6 17.8-10.4 20.4-20.4 4.8-18.1 4.8-59.8 4.8-59.8s0-41.7-4.8-59.8ZM104 127.5V52.5l66 37.5-66 37.5Z"
      />
    </svg>
  )
}
...
function AsanaIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="none" role="img" aria-label="Asana">
      <rect width="256" height="256" rx="48" fill="#F06A6A" />
      <circle cx="128" cy="100" r="28" fill="#fff" />
      <circle cx="90" cy="168" r="28" fill="#fff" />
      <circle cx="166" cy="168" r="28" fill="#fff" />
    </svg>
  )
}
