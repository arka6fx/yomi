...
function CalendlyIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="none" role="img" aria-label="Calendly">
      <rect width="256" height="256" rx="48" fill="#006BFF" />
      <path
        fill="#fff"
        d="M80 68h96c6.6 0 12 5.4 12 12v96c0 6.6-5.4 12-12 12H80c-6.6 0-12-5.4-12-12V80c0-6.6 5.4-12 12-12zm8 24v72h80V92H88zm8 8h64v56H96v-56zm8 8v40h48v-40h-48z"
      />
    </svg>
  )
}
...
function OneDriveIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="OneDrive">
      <rect x="1" y="4" width="22" height="16" rx="3" fill="#0364B8" />
      <path
        fill="#fff"
        d="M12.5 10l-3.5 4H16l-3.5-4zM7 11.5l-2.5 3H9.5L7 11.5zm10-1l2.5 4H14.5L17 10.5z"
      />
    </svg>
  )
}
...
function AttioIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="Attio">
      <rect x="1" y="1" width="22" height="22" rx="6" fill="#6C5CE7" />
      <path
...
function ZohoBooksIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="Zoho Books">
      <rect x="1" y="1" width="22" height="22" rx="6" fill="#2A4BFF" />
      <text x="12" y="16" textAnchor="middle" fontSize="12" fontWeight="bold" fill="#fff" fontFamily="system-ui">ZB</text>
    </svg>
  )
}

function ZohoInventoryIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="Zoho Inventory">
      <rect x="1" y="1" width="22" height="22" rx="6" fill="#2A4BFF" />
      <text x="12" y="16" textAnchor="middle" fontSize="12" fontWeight="bold" fill="#fff" fontFamily="system-ui">ZI</text>
    </svg>
  )
}

function ZohoDeskIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="Zoho Desk">
      <rect x="1" y="1" width="22" height="22" rx="6" fill="#2A4BFF" />
      <text x="12" y="16" textAnchor="middle" fontSize="12" fontWeight="bold" fill="#fff" fontFamily="system-ui">ZD</text>
    </svg>
  )
}

function ZohoMailIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 512 512" role="img" aria-label="Zoho Mail">
      <path
        d="M406.1 345.4c-8.3 0-15-6.7-15-15v-81.6c0-8.5-6.9-15.4-15.4-15.4H136.3c-8.5 0-15.4 6.9-15.4 15.4V266c0 8.3-6.7 15-15 15s-15-6.7-15-15v-17.1c0-24.9 20.3-45.4 45.4-45.4h239.4c24.9 0 45.4 20.3 45.4 45.4v81.6c0 8.2-6.7 14.9-15 14.9"
        fill="#f9b21d"
      />
      <path
        d="M466.6 511.9H45.4C20.5 511.9 0 491.6 0 466.5V346.8c0-8.3 6.7-15 15-15s15 6.7 15 15v119.7c0 8.5 6.9 15.4 15.4 15.4h421.3c8.5 0 15.4-6.9 15.4-15.4V212.7c0-4.8-2.1-9-5.8-12L265.5 33.5c-5.6-4.4-13.4-4.4-19.1 0L35.8 200.7c-3.7 2.8-5.8 7.2-5.8 12V264c0 5.6 3.2 10.8 8.1 13.6l210.6 112.1c4.6 2.5 9.9 2.5 14.5 0L399 317.4c7.2-3.9 16.4-1.1 20.3 6.2 3.9 7.2 1.1 16.4-6.2 20.3l-135.8 72.4c-13.4 7.1-29.3 7.1-42.5 0L24 303.9c-14.8-7.9-24-23.3-24-40v-51.4c0-13.9 6.4-26.8 17.1-35.5L227.8 10c7.9-6.4 18-9.9 28.2-9.9s20.1 3.5 28.2 9.9l210.6 167.2c10.9 8.7 17.1 21.5 17.1 35.5v254.1c.1 24.8-20.2 45.1-45.3 45.1"
        fill="#226db4"
      />
    </svg>
  )
...
function FirefliesIcon({ size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="Fireflies">
      <rect x="1" y="1" width="22" height="22" rx="6" fill="#FF6B35" />
      <path d="M12 5l1.5 4h4.5l-3.5 3 1.5 5-4-3-4 3 1.5-5L6 9h4.5L12 5z" fill="#fff" />
    </svg>
  )
}
...
const ICON_MAP: Record<string, React.FC<IconProps>> = {
  ...
  "zoho-books": ZohoBooksIcon,
  "zoho-inventory": ZohoInventoryIcon,
  "zoho-desk": ZohoDeskIcon,
  "zoho-mail": ZohoMailIcon,
