"""Per-connector example prompts (packages/shared/src/starter-prompts.ts).

Shown once a connector is connected — on its dashboard card and in the proactive
Telegram nudge. Phrased as outcomes the user can paste verbatim into Telegram,
never as feature descriptions. Keyed by connector id.
"""
...
STARTER_PROMPTS: dict[str, list[str]] = {
    ...
    "cloudflare": [
        "List the zones on my Cloudflare account",
        "Show me the firewall rules on my zone",
    ],
