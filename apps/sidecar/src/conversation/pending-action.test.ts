...
describe("PendingActionManager", () => {
  ...
  it("creates a pending action", () => {
    const action = manager.create({
      ...
      toolArguments: { owner: "test", repo: "repo", path: "main.go", content: "package main", message: "init" },
  ...
  it("getLatest returns the most recent pending action", () => {
    manager.create({ type: "github.create_file", title: "First", description: "", toolName: "t", toolArguments: {}, conversationSummary: "" })
    const second = manager.create({ type: "github.create_file", title: "Second", description: "", toolName: "t", toolArguments: {}, conversationSummary: "" })
    expect(manager.getLatest()?.id).toBe(second.id)
  })

  it("approve changes status to approved", () => {
    const action = manager.create({ type: "github.create_file", title: "Test", description: "", toolName: "t", toolArguments: {}, conversationSummary: "" })
  ...
  it("reject changes status to cancelled", () => {
    manager.create({ type: "github.create_file", title: "Test", description: "", toolName: "t", toolArguments: {}, conversationSummary: "" })
  ...
  it("approve by id works", () => {
    const a1 = manager.create({ type: "github.create_file", title: "A", description: "", toolName: "t", toolArguments: {}, conversationSummary: "" })
    const a2 = manager.create({ type: "github.create_file", title: "B", description: "", toolName: "t", toolArguments: {}, conversationSummary: "" })
  ...
  it("listPending only includes pending actions", () => {
    manager.create({ type: "github.create_file", title: "A", description: "", toolName: "t", toolArguments: {}, conversationSummary: "" })
    const b = manager.create({ type: "github.create_file", title: "B", description: "", toolName: "t", toolArguments: {}, conversationSummary: "" })
