...
export function EmailManager({ token }: { token: string }) {
  ...
  return (
    <section className="space-y-6 pt-6">
      <PageHeader
        title="email"
        subtitle="your yomi’s own address. forward receipts, tickets and bookings here, or use it for sign-ups. yomi tells you on telegram when mail arrives and logs receipts to your spending."
      />
