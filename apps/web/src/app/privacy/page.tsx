  ...
  return (
    <SitePage>
      <div className="mx-auto max-w-3xl px-6 pb-24 pt-16">
        <Mascot pose="cool" float className="float-right -mt-2 ml-4 w-20 sm:w-28" />
        ...
        <div className="max-w-none space-y-10 text-sm leading-7 text-muted-foreground">
          <Section title="Overview">
            <p>
              Yomi is an AI assistant you talk to on Telegram — by text, voice, or images — and that
              connects to your apps: Gmail, Google Calendar, Google Drive, Google Classroom, Google
              Tasks, Google Meet, GitHub, Notion, Slack, and Linear. It is designed to be private by
              default: data from your connected apps is used only to answer your direct queries and
              is not stored, shared, or used to train AI models.
            </p>
            <p>
              Two rules govern everything below.{" "}
              <strong className="text-foreground">Nothing is accessed unless you ask.</strong> Yomi
              acts on your own data, in response to your own request, and never crawls your accounts
              in the background.{" "}
          ...
          <Section title="Google API Services: User Data">
            ...
            <ul>
              ...
              <li>
                ...
                <code className="text-primary">classroom.announcements.readonly</code>) to list your
                classes, assignments, and announcements and check your own submission status.
              </li>
              <li>
            ...
            <p>
              <strong className="text-foreground">Limited Use.</strong> Yomi&apos;s use and transfer
              of information received from Google APIs to any other app will adhere to the{" "}
              <a
            ...
            <p>
              ...
              consent (for example if you send us a message to debug a problem), where necessary for
              security purposes such as investigating abuse, or where required by law.
            </p>
            <p>
            ...
            <p>
              <strong className="text-foreground">Retention.</strong> Content fetched from a Google
              API to answer a request is held in memory for that request and discarded once the
          ...
          <Section title="Data handling during queries">
            <p>
              When you send a message, any image you attach and your transcribed voice text are sent
              to our LLM proxy to generate a response. Neither is stored after the request
          ...
          <Section title="Third-party services">
            ...
            <ul>
              <li>
                ...
                Composio-backed connectors, Yomi stores only a reference to the connection, not your
                access tokens. Governed by{" "}
                <a
              ...
              <li>
                ...
                . Yomi&apos;s use complies with the Google API Services User Data Policy, including
                Limited Use requirements.
              </li>
              <li>
                <strong className="text-foreground">OpenAI</strong>: LLM inference via our proxy,
                plus speech-to-text for voice messages you send (Yomi always replies in text). Query
              ...
              <li>
                ...
                infrastructure and are subject to their privacy policy. Linking is optional and can
          ...
          <Section title="Security">
            <p>
              Memory blobs are encrypted at rest using AES-256. OAuth tokens for MCP connectors are
              encrypted. We use HTTPS for all data in transit. We conduct regular security reviews.
            </p>
          </Section>
