    ...
    <div className="landing-light site-texture-bg-light min-h-screen text-foreground">
      ...
      <main className="pt-16">
        <div className="mx-auto max-w-3xl px-6 py-24">
          ...
          <h1 className="mb-2 font-accent text-5xl text-foreground">Character guidelines</h1>
          ...
          <div className="space-y-10 text-sm leading-7 text-muted-foreground">
            ...
            <Section title="Hard lines">
              ...
              <p>
                Some of these are checked automatically when you save a character. The checks are
                not perfect, so the rules apply whether or not a check catches something.
              </p>
            </Section>
            ...
            <Section title="Pictures and names">
              <p>
                ...
                pictures show their source under the character. If you own a character or picture
                and want it taken down, see our <Link href="/copyright">copyright page</Link>.
              </p>
            </Section>
            ...
            <Section title="Reporting">
              <p>
                ...
                <a href="mailto:contact.arkagarai@gmail.com">contact.arkagarai@gmail.com</a> with
                the character&rsquo;s name and what&rsquo;s wrong. We read every report.
              </p>
            </Section>
          </div>
        </div>
