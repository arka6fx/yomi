    ...
    <div className="landing-light site-texture-bg-light min-h-screen text-foreground">
      ...
      <main className="pt-16">
        <div className="mx-auto max-w-3xl px-6 py-24">
          ...
          <h1 className="mb-2 font-accent text-5xl text-foreground">Copyright and takedowns</h1>
          ...
          <div className="space-y-10 text-sm leading-7 text-muted-foreground">
            <Section title="Our approach">
              <p>
                ...
                endorsed by the owners of the original work. Pictures carry a credit to their
                source. We respect creators&rsquo; rights and act quickly on valid requests.
              </p>
            </Section>
            ...
            <Section title="If your character was removed">
              <p>
                If you believe a character you made was removed by mistake, or you have the rights
                to it, reply to our notice or email us with the details. We may restore it or pass
                your reply on to the person who complained.
              </p>
            </Section>

            <Section title="Repeat problems">
              <p>
                Accounts that repeatedly upload material they don&rsquo;t have the rights to may
                lose access to characters or to Yomi. See also our{" "}
