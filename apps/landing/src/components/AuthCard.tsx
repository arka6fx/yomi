...
export default function AuthCard({ defaultMode }: AuthCardProps) {
    ...
    <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8">
      ...
      <div className="flex flex-col gap-3">
        <button
          ...
          className="flex items-center justify-center gap-3 rounded-xl border border-border bg-background hover:bg-muted/50 transition-colors py-3 text-sm font-medium text-foreground"
        >
      ...
      <p className="text-center text-sm text-muted-foreground mt-6">
        ...
        <Link
          href={defaultMode === "signup" ? "/signin" : "/signup"}
