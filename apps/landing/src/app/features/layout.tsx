...
export const metadata: Metadata = {
  title: "Features",
  description:
    "Yomi sees your screen, transcribes your voice in under 2 seconds, and connects to Gmail, Google Calendar, Google Drive, GitHub, Slack, Notion, Linear, and Discord — all from your Windows system tray.",
