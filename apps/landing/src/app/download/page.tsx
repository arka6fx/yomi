    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="text-center p-8">
          ...
          <p className="text-slate-600 mb-6">Desktop app releases haven't been published yet.</p>
          <a
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-16 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600">Your AI-powered desktop assistant for Windows</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <div className="flex items-start gap-6 mb-8">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-slate-900 mb-2">Yomi for Windows</h2>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800 mb-3">
                Since Yomi is not yet code-signed, Windows SmartScreen may show a warning when you
                run the installer. This is normal for new applications.
              </p>
