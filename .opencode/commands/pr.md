...
If already on `main`, stop: "Create a feature branch first."
If no commits ahead of main, stop: "Nothing to open a PR for."
...
Otherwise derive the title from `git log main..HEAD --oneline` (first line, strip hash prefix).
