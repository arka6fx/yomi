...
Cross-platform AI buddy (Mac menu bar, Windows tray) that routes requests
between a fast linear pipeline and a background ReAct agent loop. The
...
- Tauri port: decide at Phase 4 based on Electron pain points observed in Phase
  0–3.
- Proactive hooks (screen-context changes): opt-in UX design needed before
  Phase 2.
