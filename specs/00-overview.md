...
Yomi is an AI productivity assistant for voice, text, images, Telegram, and
connected work apps.
...
- Landing/dashboard for account, billing, bot linking, and integrations.

Primary paths:

- Fast path: STT or text, optional image, one model call.
