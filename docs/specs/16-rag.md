...
- **`index_document`** — index the most recently uploaded PDF/Word file. The
  ...
  `docs/specs/archive/superpowers/specs/2026-08-04-index-document-reference-redesign-design.md`).
...
Design detail:
`docs/specs/archive/superpowers/specs/2026-07-06-drive-rag-autosync-design.md`.
