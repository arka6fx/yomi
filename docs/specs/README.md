...
`AGENTS.md` and [`../architecture.md`](../architecture.md). For old per-feature
design/plan artifacts, see `archive/`.
...
| [11](11-database.md)                     | Database — Cloudflare D1 tables                     |
| [12](12-backend.md)                      | Backend — FastAPI Container, auth, billing, gateway |
| [13](13-pricing.md)                      | Pricing — pure-credit model                         |
| [14](14-landing-page.md)                 | Web site + dashboard                                |
...
live in `apps/api/src/yomi/connectors/` (Python port in progress).
